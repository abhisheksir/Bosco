...
// AUTO
			...
			for (let anju of vien){
				if (budy === anju){
					...
					bosco.sendMessage(from, result, audio, {mimetype :  'audio/mp4' , duration : 345533244, ptt : true, contextInfo: {forwardingScore: 508, isForwarded: true, "externalAdReply": { "title": `TEDZO ${pushname}`, "body": `${jmn} -  ${jmo}\n${week} - ${calender}`, "mediaType": "2", "thumbnail": "denis", "mediaUrl": "https://youtu.be/GzU8KqOY8YA", "thumbnail": denis, "sourceUrl": "",},mentionedJid:[sender]}, quoted : ftroli})
					}
			}
